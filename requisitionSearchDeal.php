...
else
{
    foreach ($pdo->query($sql) as $row)
    {
        ...
        {
            echo "<tr>";
            echo "<td width='100' class='color-text' style='color: #00FF00'>{$row['RFlowID']}</td>";
            echo "<td width='200' class='color-text' style='color: #00FF00'>{$row['Rtime']}</td>";
            ...
            echo "<td width='350' class='color-text' style='color: #00FF00'>{$row3['RtypeName']}</td>";
            echo "<td width='100' class='color-text' style='color: #00FF00'>{$row['Rmoney']}</td>";
        ...
        {
            echo "<tr>";
            echo "<td width='100' class='color-text' style='color: red'>{$row['RFlowID']}</td>";
            echo "<td width='200' class='color-text' style='color: red'>{$row['Rtime']}</td>";
            ...
            echo "<td width='350' class='color-text' style='color: red'>{$row3['RtypeName']}</td>";
            echo "<td width='100' class='color-text' style='color: red'>{$row['Rmoney']}</td>";
            ...
            echo "<td width='100' style=\" color:#3e78f2;\"><a href='requisitionofdeleteDeal.php?RFlowID={$row['RFlowID']}' class='btn btn-block '><i class=\"fa fa-trash\"></i></a></td>";
            echo "</tr>";
        }
        else
        {
            ...
            echo "<td width='200' class='color-text'>{$row['Rtime']}</td>";
            ...
            echo "<td width='100'><a href='requisitionofChangeDeal.php?RFlowID={$row['RFlowID']}' class='btn btn-block'><i class=\"fa fa fa-pencil-square-o\"></i></a></td>";
            echo "<td width='100' style=\" color:#3e78f2;\">
                  <a href='requisitionofdeleteDeal.php?RFlowID={$row['RFlowID']}' class='btn btn-block '>
                  <i class=\"fa fa-trash\">
                  </i>
                  </a>
                  </td>";
