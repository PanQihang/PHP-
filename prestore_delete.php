...
else
{
    foreach ($pdo->query($sql) as $row) {
        ...
        echo "<tr>";
        echo "<td width='100'style=\" color:#3e78f2;\">{$row['PFlowID']}</td>";
        echo "<td width='150'style=\" color:#3e78f2;\">{$row['Ptime']}</td>";
        echo "<td width='150'style=\" color:#3e78f2;\">{$row1['Aname']}</td>";
        echo "<td width='350'style=\" color:#3e78f2;\">{$row2['ProductName']}</td>";
        echo "<td width='350'style=\" color:#3e78f2;\">{$row3['PtypeName']}</td>";
        echo "<td width='100'style=\" color:#3e78f2;\">{$row['Pmoney']}</td>";
        echo "<td width='100'style=\" color:#3e78f2;\"><a href='prestoreDeleteDeal.php?PFlowID={$row['PFlowID']}' class='btn btn-block btn-danger'><i class=\"fa fa-trash\"></i></a></td>";
        echo "</tr>";
    }
}
