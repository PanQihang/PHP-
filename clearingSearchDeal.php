...
if($row==null)
{
    ...
    echo "<td width='300' class=\" color-text\">无</td>";
    echo "<td width='200' class=\" color-text\">无</td>";
    echo "<td width='150' class=\" color-text\">无</td>";
    echo "<td width='150' class=\" color-text\">无</td>";
...
else
{
    foreach ($pdo->query($sql) as $row)
    {
		...
		$sql4 = "SELECT WtypeName FROM webtype WHERE WtypeID = '$d'";
        ...
        {
            echo "<tr>";
            echo "<td width='150' class='color-text' style='color: #00FF00'>{$row['WFlowID']}</td>";
            echo "<td width='150'  class='color-text' style='color: #00FF00'>{$row['Wtime']}</td>";
            echo "<td width='200'  class='color-text' style='color: #00FF00'>{$row1['Aname']}</td>";
            echo "<td width='300'  class='color-text' style='color: #00FF00'>{$row2['ProductName']}</td>";
            echo "<td width='200'  class='color-text' style='color: #00FF00'>{$row3['WoperatorName']}</td>";
            echo "<td width='150'  class='color-text' style='color: #00FF00'>{$row4['WtypeName']}</td>";
            echo "<td width='150'  class='color-text' style='color: #00FF00'>{$row['Wmoney']}</td>";
		...
		{
            echo "<tr>";
            echo "<td width='150' class='color-text' style='color: red'>{$row['WFlowID']}</td>";
            echo "<td width='150'  class='color-text' style='color: red'>{$row['Wtime']}</td>";
            echo "<td width='200'  class='color-text' style='color: red'>{$row1['Aname']}</td>";
            echo "<td width='300'  class='color-text' style='color: red'>{$row2['ProductName']}</td>";
            echo "<td width='200'  class='color-text' style='color: red'>{$row3['WoperatorName']}</td>";
            echo "<td width='150'  class='color-text' style='color: red'>{$row4['WtypeName']}</td>";
            echo "<td width='150'  class='color-text' style='color: red'>{$row['Wmoney']}</td>";
            ...
            echo "<td width='100' class='color-text'><a href='clearOfDeleteDeal.php?WFlowID={$row['WFlowID']}'class='btn btn-block '><i class=\"fa fa-trash\"></i></a></td>";
            echo "</tr>";
		}
		else
		{
            echo "<tr>";
            echo "<td width='150' class='color-text'>{$row['WFlowID']}</td>";
            echo "<td width='150'  class='color-text'>{$row['Wtime']}</td>";
            echo "<td width='200'  class='color-text'>{$row1['Aname']}</td>";
            echo "<td width='300'  class='color-text'>{$row2['ProductName']}</td>";
            echo "<td width='200'  class='color-text'>{$row3['WoperatorName']}</td>";
            echo "<td width='150'  class='color-text'>{$row4['WtypeName']}</td>";
            echo "<td width='150'  class='color-text'>{$row['Wmoney']}</td>";
            echo "<td width='100' class='color-text'><a href='clearOfchangeDeal.php?WFlowID={$row['WFlowID']}'class='btn btn-block'><i class=\"fa fa fa-pencil-square-o\"></i></a></td>";
            echo "<td width='100' class='color-text'><a href='clearOfDeleteDeal.php?WFlowID={$row['WFlowID']}'class='btn btn-block '><i class=\"fa fa-trash\"></i></a></td>";
            echo "</tr>";
        }
